...
let SessionsController = class SessionsController {
    ...
    create(body) { return this.sessionsService.create(body); }
    update(id, sessions) { return this.sessionsService.update(id, sessions); }
    remove(id) { return this.sessionsService.remove(id); }
};
