...
let ProgramsController = class ProgramsController {
    ...
    create(body) { return this.programsService.create(body); }
    update(id, body) { return this.programsService.update(id, body); }
    remove(id) { return this.programsService.remove(id); }
};
