...
let InstructorsController = class InstructorsController {
    ...
    create(body) { return this.instructorsService.create(body); }
    update(id, body) { return this.instructorsService.update(id, body); }
    remove(id) { return this.instructorsService.remove(id); }
};
