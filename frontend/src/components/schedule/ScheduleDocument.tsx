...
import type { Session } from "@/components/schedule/ExamTable";
...
export function ScheduleDocument({
  ...
  function handleModalSuccess(message: string) {
    ...
    // router.refresh(); // Let Socket.io handle the data refresh to avoid clearing toast state
  }
